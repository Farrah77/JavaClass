...
*    method with the same name which returns the percentage of the students. The constructor
*    of student A takes the marks in three subjects as its parameters and the marks in four
...
class TestMarks{
    ...
    public static void main(String[] args) {
        ...
        Marks obj=new A(80,70,95);
        obj.getPercentage();
        System.out.println();
        
        Marks obj1=new B( 45,78,96,100);
        obj1.getPercentage();
